...
WebUI.callTestCase(findTestCase('UTILITIES/COVID19/Search Item Homepage'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('nav_to_storefront/input_search'), 'uploaded in automated')

WebUI.click(findTestObject('nav_to_storefront/btn_search'))

WebUI.verifyElementPresent(findTestObject('nav_to_storefront/find_flag'), 0)
