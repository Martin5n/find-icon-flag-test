...
WebUI.setText(findTestObject('homepage_search/input_search'), 'item1598418357')
...
WebUI.click(findTestObject('nav_to_storefront/seller_without_find'))

WebUI.setText(findTestObject('nav_to_storefront/input_search'), 'item1598418357')
